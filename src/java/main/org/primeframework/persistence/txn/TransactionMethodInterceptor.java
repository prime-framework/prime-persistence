...
public class TransactionMethodInterceptor implements MethodInterceptor {
   ...
   * is then used to determine if the transaction is new or embedded. This then handles the starting, committing and
   * rolling back of the transaction based on the result of the method invocation and if the transaction is embedded
   * or not.
   *
