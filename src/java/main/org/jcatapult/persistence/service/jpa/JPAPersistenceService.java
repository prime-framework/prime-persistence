...
public class JPAPersistenceService implements PersistenceService {
   ...
   * org.jcatapult.persistence.domain.SoftDeletable} and appends "where eb.deleted = false" if the includeDeleted is
   * false.
   *
   ...
   * org.jcatapult.persistence.domain.SoftDeletable} this and the includeInactive flag is false method also appends
   ...
   * <p/>
   * <table> <tr><th>Class</th><th>Return</th></tr> <tr><td>org.jcatapult.project.domain.Photo</td><td>Photo</td>
   * <tr><td>org.jcatapult.project.Foo</td><td>Foo</td> <tr><td>NoPackageClass</td><td>NoPackageClass</td> </table>
   *
